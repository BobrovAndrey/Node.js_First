...
//Checks POST
//Required data: potocol, url, method, successCodes, timeoutSeonds
// Optional data: none
...
handlers._checks.post = function(data,callback){
  ...
  let method = typeof(data.payload.method) == 'string' && ['post', 'get', 'put', 'delete'].indexOf(data.payload.protocol) > -1 ? data.payload.method : false;
  let successCodes = typeof(data.payload.successCodes) == 'object' && data.payload.successCodes instanceof Array && data.payload.successCodes.length > 0 ? data.payload.successCodes : false;
  let timeoutSeonds = typeof(data.payload.timeoutSeonds) == 'number' && data.payload.timeoutSeonds % 1 === 0 && data.payload.timeoutSeonds >= 1 && data.payload.timeoutSeonds <= 5 ? data.payload.timeoutSeonds : false;
