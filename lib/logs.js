...
//Compress the contents of one .log file into a .gs.b64 file within the same directory
lib.compress = function(logId,newFileId,callback){
  let sourseFile = logId+'.log';
  let destFile = newFileId+'.gs.b64';

  //Read the source file
  fs.readFile(lib.baseDir+sourseFile,'utf8',function(err,inputString){
    if(!err && inputString){
